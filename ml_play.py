        ...
        def move(grid, speed_ahead, speed_behind_left, speed_behind_right, speed_front_ahead): 
            ...
            if len(grid) == 0:
                ...
                if (2 not in grid): # Check forward 前方沒車就往前（沒2必沒5)
                    #Back to lane center
                    if (3 not in grid) and (6 not in grid) and (9 not in grid) and (11 not in grid) and self.car_lane == 0 :
                        return ["SPEED", "MOVE_RIGHT"]
                    elif (1 not in grid) and (4 not in grid) and (7 not in grid) and(10 not in grid) and self.car_lane == 8:
                    ...
                    if (5 in grid): # NEED to BRAKE 
                        if(prior == "right"):
                            if (6 not in grid) and speed_behind_right < self.car_vel: # turn right
                            ...
                            if (4 not in grid) and speed_behind_left < self.car_vel: # turn left 
                                if self.car_vel < speed_ahead - 0.5:
                                    return ["SPEED", "MOVE_LEFT"]
                                else:
                                    if self.player_no == 0:
